...
if __name__ == '__main__':
    ...
    if is_tiny_version:
        model = create_tiny_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='weights_yolo_train/trained_weights_final.h5')
    else:
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='weights_yolo_train/trained_weights_final.h5') # make sure you know what you freeze
